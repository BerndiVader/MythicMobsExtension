...
package com.gmail.berndivader.mythicmobsext.utils.math.geom;

import java.util.ArrayList;
import java.util.List;

import com.gmail.berndivader.mythicmobsext.utils.BlockVector2D;
...
public final class Polygons {
	...
	public static List<BlockVector2D> polygonizeCylinder(Vector2D center, Vector2D radius, int maxPoints) {
		...
		// These strange semantics for maxPoints are copied from the selectSecondary
		// method.
