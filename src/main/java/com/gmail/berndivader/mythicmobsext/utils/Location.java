...
public class Location {
	...
	/**
	 * Create a new instance in the given extent at 0, 0, 0 with a direction vector
	 * of 0, 0, 0.
	 *
	...
	/**
	 * Create a new instance in the given extent with the given coordinates with a
	...
	/**
	 * Create a new instance in the given extent with the given position vector and
	...
	/**
	 * Create a new instance in the given extent with the given coordinates and the
	...
	/**
	 * Return a copy of this object with the X component of the new object set to
	 * the given value.
	 *
	...
	/**
	 * Return a copy of this object with the Y component of the new object set to
	 * the given value.
	 *
	...
	/**
	 * Return a copy of this object with the Z component of the new object set to
	 * the given value.
	 *
