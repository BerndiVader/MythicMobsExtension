...
public class AffineTransform implements Transform {
	...
	public AffineTransform(double xx, double yx, double zx, double tx, double xy, double yy, double zy, double ty,
	...
	public AffineTransform inverse() {
		...
		return new AffineTransform((m11 * m22 - m21 * m12) / det, (m21 * m01 - m01 * m22) / det,
				(m01 * m12 - m11 * m02) / det,
	 ...
	 * given by {@code that}, then this affine transform.
	 *
	 ...
	 * then the affine transform given by {@code that}.
	 *
	...
	public Vector apply(Vector vector) {
		return new Vector(vector.getX() * m00 + vector.getY() * m01 + vector.getZ() * m02 + m03,
	...
	public String toString() {
		return String.format("Affine[%g %g %g %g, %g %g %g %g, %g %g %g %g]}", m00, m01, m02, m03, m10, m11, m12, m13,
				m20, m21, m22, m23);
	}
