...
Listener {
	...
	public class InternalsLoader {
		...
		public Class<? extends SkillMechanic> loadMechanicClass(String s1) {
			try {
				Class<?>c1=null;
				try {
					c1=Class.forName(Classloader.mechanics.get(s1));
		...
		public Class<? extends SkillCondition> loadConditionClass(String s1) {
			try {
				Class<?>c1=null;
				try {
					c1=Class.forName(Classloader.conditions.get(s1));
				} catch (ClassNotFoundException e1) {
					e1.printStackTrace();
				}
		...
		public Class<? extends SkillTargeter> loadTargeterClass(String s1) {
			try {
				Class<?>c1=null;
				try {
					c1=Class.forName(Classloader.targeters.get(s1));
				} catch (ClassNotFoundException e1) {
					e1.printStackTrace();
				}
