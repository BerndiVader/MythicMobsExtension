...
@ConditionAnnotation(name="samespawner",author="BerndiVader")
...
IEntityComparisonCondition {
	...
	public boolean check(AbstractEntity caster, AbstractEntity target) {
		ActiveMob cm=Utils.mobmanager.getMythicMobInstance(caster),tm=Utils.mobmanager.getMythicMobInstance(target);
		if (cm!=null&&tm!=null) {
