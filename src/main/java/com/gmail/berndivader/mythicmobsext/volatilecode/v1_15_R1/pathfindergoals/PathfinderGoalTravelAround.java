...
PathfinderGoal
{
	...
	net.minecraft.server.v1_15_R1.World a;
	...
	@Override
	public void e() {
		d.getControllerLook().a(v.x,v.y,v.z,10.0F,d.dU());
		if (h--<=0) {
			h=10;
	...
	protected boolean a(int i, int j, int k, int l, int i1) {
		...
		return (iblockdata.c(a,blockposition,EnumDirection.DOWN)==1)&&(a.isEmpty(blockposition.up()))&&(a.isEmpty(blockposition.up(2)));
	}
