...
import net.minecraft.server.v1_15_R1.IPosition;
...
Navigation 
{
    ...
    public void c() {
        if (this.n()) {
            if (this.i != null) {
                if (this.i.a((IPosition)this.a.getPositionVector(), (double)this.a.getWidth()) || this.a.locY() > (double)this.i.getY() && new BlockPosition((double)this.i.getX(), this.a.locY(), (double)this.i.getZ()).a((IPosition)this.a.getPositionVector(), (double)this.a.getWidth())) {
                    this.i=null;
                } else {
