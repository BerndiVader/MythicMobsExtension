...
PathfinderGoal {
    ...
    @Override
    public boolean a() {
    	if (!this.a.positionChanged||(bl1&&!this.a.world.getGameRules().getBoolean(GameRules.MOB_GRIEFING))) return false;
        Navigation n1=(Navigation)this.a.getNavigation();
        PathEntity pe1=n1.l();
        if (pe1==null||pe1.b()||!n1.f()) return false;
        for (int i1=0;i1<Math.min(pe1.f()+2,pe1.e());i1++) {
            PathPoint pp1=pe1.a(i1);
            this.b=new BlockPosition(pp1.a,pp1.b+1,pp1.c);
            if (this.a.e(this.b.getX(),this.a.locY,this.b.getZ())>2.25) continue;
