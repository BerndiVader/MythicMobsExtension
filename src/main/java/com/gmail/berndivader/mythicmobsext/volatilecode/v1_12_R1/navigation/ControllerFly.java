...
ControllerMove {
    ...
    public void a() {
        if (this.h == Operation.STRAFE) {
            ...
            if (navigationAbstract!=null&&(pathfinderAbstract=navigationAbstract.r())!=null&&pathfinderAbstract.a(this.a.world,MathHelper.floor(this.a.locX+(double)f9),MathHelper.floor(this.a.locY),MathHelper.floor(this.a.locZ+(double)f10))!=PathType.WALKABLE) {
                this.f=1.0f;
                this.g=0.0f;
                f3=f2;
            }
