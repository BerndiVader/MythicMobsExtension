...
public class ControllerFly extends ControllerMove {
	...
	public void a() {
		if (this.h == Operation.STRAFE) {
			...
			if (navigationAbstract != null && (pathfinderAbstract = navigationAbstract.r()) != null
			...
			float f3 = this.a.onGround
					? (float) (this.e * this.a.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).getValue())
					: (float) (this.e * this.a.getAttributeInstance(GenericAttributes.e).getValue());
			this.a.k(f3);
