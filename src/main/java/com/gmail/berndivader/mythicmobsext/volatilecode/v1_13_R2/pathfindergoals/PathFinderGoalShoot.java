...
public class PathFinderGoalShoot extends PathfinderGoal {
    ...
    public void c() {
        super.c();
        if (this.a instanceof IRangedEntity) ((IRangedEntity)this.a).s(true);
    }

    @Override
    public void d() {
        super.d();
        if (this.a instanceof IRangedEntity) ((IRangedEntity)this.a).s(false);
        this.f = 0;
        this.d1 = -1;
        this.a.da();
    }
    ...
    public void e() {
        ...
        double d2 = this.a.d(entityLiving.locX, entityLiving.getBoundingBox().maxY, entityLiving.locZ);
        ...
        if (--this.d1 == 0) {
            ...
            if (this.a instanceof IRangedEntity) {
            	...
            	if (am!=null) am.signalMob(BukkitAdapter.adapt(entityLiving.getBukkitEntity()),Utils.signal_AISHOOT);
            }
