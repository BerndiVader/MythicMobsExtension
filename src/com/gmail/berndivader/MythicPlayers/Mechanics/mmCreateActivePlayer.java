...
public class mmCreateActivePlayer extends SkillMechanic implements ITargetedEntitySkill {
	...
	public boolean castAtEntity(SkillMetadata data, AbstractEntity target) {
        ...
        if (mm==null || !target.isPlayer() || !mm.isPersistent()
        		|| MythicPlayers.inst().getPlayerManager().isActivePlayer(target.getUniqueId())) return false;
        return MythicPlayers.inst().getPlayerManager().createActivePlayer((LivingEntity) target.getBukkitEntity(), mm);
	}
